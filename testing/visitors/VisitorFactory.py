...
from testing.visitors.duplicated_blocks.DuplicatedBlocksCountVisitor import DuplicatedBlocksCountVisitor
from testing.visitors.maintainability_rating.SqaleRatingVisitor import SqaleRatingVisitor
from testing.visitors.reliability_rating.LevelOfReliabilityVisitor import LevelOfReliabilityVisitor
from testing.visitors.security_issues.TotalSecurityIssuesVisitor import TotalSecurityIssuesVisitor
from testing.visitors.security_rating.LevelOfSecurityVisitor import LevelOfSecurityVisitor
from testing.visitors.size.avg_length_of_functions.AvgLinesOfCodePerFunctionVisitor import \
    AvgLinesOfCodePerFunctionVisitor
from testing.visitors.community_vitality.RepositoryAgeMeasureVisitor import RepositoryAgeMeasureVisitor
from testing.visitors.communitycapability.change_request_acceptance_ratio.ReviewsAcceptedToDeclinedRatioAggregator import \
    ReviewsAcceptedToDeclinedRatioAggregator
from testing.visitors.communitycapability.change_request_commits.AvgNumberOfCommitsPerPRsVisitor import \
    AvgNumberOfCommitsPerPRsVisitor
from testing.visitors.communitycapability.change_request_contributors.AvgNumberOfContributorsPerPRsVisitor import \
    AvgNumberOfContributorsPerPRsVisitor
from testing.visitors.communitycapability.LinesChangedCountVisitor import LinesChangedCountVisitor
from testing.visitors.communitycapability.change_request_reviews.PercentageOfPRsReviewedVisitor import \
    PercentageOfPRsReviewedVisitor
from testing.visitors.communitycapability.change_requests_duration.DurationToResolvePullRequestsVisitor import \
    DurationToResolvePullRequestsVisitor
from testing.visitors.communitycapability.community_growth.AssetDownloadCountVisitor import AssetDownloadCountVisitor
from testing.visitors.communitycapability.community_growth.ClosedIssuesCountByNewContributorsAggregator import \
    ClosedIssuesCountByNewContributorsAggregator
from testing.visitors.communitycapability.community_growth.ClosedIssuesPercentageByNewContributorsAggregator import \
    ClosedIssuesPercentageByNewContributorsAggregator
from testing.visitors.communitycapability.community_growth.InactiveContributorCountVisitor import \
    InactiveContributorCountVisitor
from testing.visitors.communitycapability.community_growth.NewContributorsVisitor import NewContributorsVisitor
from testing.visitors.communitycapability.issue_resolution.issues_active.ActiveIssuesRatioVisitor import \
    ActiveIssuesRatioVisitor
from testing.visitors.communitycapability.issue_resolution.issues_closed.ClosedIssuesRatioVisitor import \
    ClosedIssuesRatioVisitor
from testing.visitors.communitycapability.issue_resolution.issues_new.NewIssuesCountVisitor import NewIssuesCountVisitor
from testing.visitors.communitycapability.issue_resolution.issues_new.NewIssuesRatioVisitor import NewIssuesRatioVisitor
from testing.visitors.gunning_fog.AvgGunningFogIndexVisitor import AvgGunningFogIndexVisitor
from testing.visitors.maintainer_organization.OrgCountMeasureVisitor import OrgCountMeasureVisitor
from testing.visitors.number_of_open_feature_request.OpenFeatureRequestCountVisitor import \
    OpenFeatureRequestCountVisitor
from testing.visitors.numberofreleases.ReleaseCountVisitor import ReleaseCountVisitor
from testing.visitors.open_participation.NewContributorsCountVisitor import NewContributorsCountVisitor
from testing.visitors.peer_influence.RepoMessagesVisitor import RepoMessagesVisitor
from testing.visitors.popularity.AnnualCommitCountVisitor import AnnualCommitCountVisitor
from testing.visitors.popularity.DownloadsCountVisitor import DownloadsCountVisitor
from testing.visitors.popularity.ForksCountVisitor import ForksCountVisitor
from testing.visitors.popularity.StarsCountVisitor import StarsCountVisitor
from testing.visitors.popularity.WatchersCountVisitor import WatchersCountVisitor
from testing.visitors.product_evolution.CommitCountVisitor import CommitCountVisitor
from testing.visitors.product_evolution.declined_changes.ReviewsDeclinedCountVisitor import ReviewsDeclinedCountVisitor
from testing.visitors.product_evolution.declined_changes.ReviewsDeclinedAggregator import ReviewsDeclinedAggregator
from testing.visitors.product_evolution.issue_interactions.UpdatedIssuesCountVisitor import UpdatedIssuesCountVisitor
from testing.visitors.product_evolution.opened_pull_requests.OpenedPullRequestCountVisitor import \
    OpenedPullRequestCountVisitor
from testing.visitors.product_evolution.reviews_accepted.ReviewsAcceptedCountVisitor import ReviewsAcceptedCountVisitor
from testing.visitors.product_evolution.reviews_accepted.ReviewsAcceptedRatioVisitor import ReviewsAcceptedRatioVisitor
from testing.visitors.product_evolution.staleness.OpenIssueAgeVisitor import OpenIssueAgeVisitor
from testing.visitors.product_evolution.updated_since.TimeSinceLastCommitVisitor import TimeSinceLastCommitVisitor
from testing.visitors.size.number_of_classes.ClassesCountVisitor import ClassesCountVisitor
from testing.visitors.size.number_of_files.FilesCountVisitor import FilesCountVisitor
from testing.visitors.software_quality.MaintainabilityIssuesVisitor import MaintainabilityIssuesVisitor
from testing.visitors.software_quality.ReliabilityRemediationEffortVisitor import ReliabilityRemediationEffortVisitor
from testing.visitors.software_quality.SecurityRemediationEffortVisitor import SecurityRemediationEffortVisitor
from testing.visitors.communitycapability.AugurClosedIssuesCountVisitor import AugurClosedIssuesCountVisitor
from testing.visitors.communitycapability.AugurIssueThroughputVisitor import AugurIssueThroughputVisitor
from testing.visitors.communitycapability.AugurTotalIssuesCountVisitor import AugurTotalIssuesCountVisitor
...
class MeasurableConceptVisitorFactory(VisitorFactory):
    def __init__(self):
        self.visitor_mappings = {
            ...
            "LegacyMaintainabilityRating": (NoOpNormalizeVisitor, AddAggregateVisitor),
